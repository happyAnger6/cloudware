...
const (
	...
	ErrDockerContainerIdentifierNotFound = api.Error("Docker container identifier not found")
...
func decorateContainerList(containerData []interface{}, resourceControls []api.ResourceControl) ([]interface{}, error) {
...
func filterContainersWithBlackListedLabels(containerData []interface{}, labelBlackList []api.Pair) ([]interface{}, error) {
	filteredContainerData := make([]interface{}, 0)
...
func containerHasBlackListedLabel(containerLabels map[string]interface{}, labelBlackList []api.Pair) bool {
