...
const (
	...
	ErrDockerNetworkIdentifierNotFound = api.Error("Docker network identifier not found")
...
func decorateNetworkList(networkData []interface{}, resourceControls []api.ResourceControl) ([]interface{}, error) {
