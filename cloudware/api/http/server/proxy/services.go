...
const (
	...
	ErrDockerServiceIdentifierNotFound = api.Error("Docker service identifier not found")
...
func decorateServiceList(serviceData []interface{}, resourceControls []api.ResourceControl) ([]interface{}, error) {
