...
const (
	...
	ErrDockerConfigIdentifierNotFound = api.Error("Docker config identifier not found")
	configIdentifier                  = "ID"
)
...
func decorateConfigList(configData []interface{}, resourceControls []api.ResourceControl) ([]interface{}, error) {
