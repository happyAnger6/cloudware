...
const (
	...
	ErrDockerSecretIdentifierNotFound = api.Error("Docker secret identifier not found")
	secretIdentifier                  = "ID"
)
...
func decorateSecretList(secretData []interface{}, resourceControls []api.ResourceControl) ([]interface{}, error) {
