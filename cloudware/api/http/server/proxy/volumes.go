...
const (
	...
	ErrDockerVolumeIdentifierNotFound = api.Error("Docker volume identifier not found")
...
func decorateVolumeList(volumeData []interface{}, resourceControls []api.ResourceControl) ([]interface{}, error) {
