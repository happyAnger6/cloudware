...
func (m *Migrator) Migrate() error {
	...
	// https://github.com/api/api/issues/1235
	...
	// https://github.com/api/api/issues/1236
	...
	// https://github.com/api/api/issues/1449
	...
	err := m.VersionService.StoreDBVersion(api.DBVersion)
	if err != nil {
		return err
	}
	return nil
